...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onNmeaReceived:(JLjava/lang/String;)V:GetOnNmeaReceived_JLjava_lang_String_Handler:Android.Locations.GpsStatus/INmeaListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n" +
			"";
		mono.android.Runtime.register ("Tracking.Services.TrackingService, tracking.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TrackingService.class, __md_methods);
	}
	...
	public TrackingService ()
	{
		...
		if (getClass () == TrackingService.class)
			mono.android.TypeManager.Activate ("Tracking.Services.TrackingService, tracking.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
