...
{
	public class TrackingServiceConnection : Java.Lang.Object, IServiceConnection
	{
		public event EventHandler<ServiceConnectedEventArgs> ServiceConnected = delegate {};

		public TrackingServiceBinder Binder
		{
			get { return this.binder; }
			set { this.binder = value; }
		}
		protected TrackingServiceBinder binder;

		public TrackingServiceConnection (TrackingServiceBinder binder)
		{
			if (binder != null) {
				this.binder = binder;
			}
		...
		public void OnServiceConnected (ComponentName name, IBinder service)
		{
			...
			TrackingServiceBinder serviceBinder = service as TrackingServiceBinder;
